    ...
    return (
        <div className="h-full w-full bg-background-light flex overflow-hidden">
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden h-full">
                ...
                {/* Mobile Header */}
                <header className="lg:hidden flex items-center justify-between p-4 bg-surface-light border-b border-border-color shrink-0 shadow-sm z-20">
                    ...
                    <button 
                        ...
                        className="p-2 text-gray-500 hover:bg-gray-100 hover:text-primary rounded-lg transition-colors cursor-pointer"
